...
if (antiVirtex) {
    ...
    if (AntiLink) {
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Yt video link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Yt channel link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Instagram link in this group! No promotion is allowed!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Facebook link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Telegram link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Tiktok link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending Twitter link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} The MF has been removed for sending links in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Hello ${pushname} Bro 👋. I am ${global.BotName}, a bot developed by: ᴹᴿ᭄ ᴊᴜɪᴄᴇོ ×፝֟͜× to take your WhatsApp usage into next level.
...
switch(command) {
    ...
    title:"Powered by ᴹᴿ᭄ ᴊᴜɪᴄᴇོ ×፝֟͜×",
    body: " ", 
...
if (args[0] === "on") {
if (isBanChat) return replay('This Group is Already Banned from using BayMax!')
banchat.push(from)
replay('This Group has been banned from using BayMax!')
...
replay('This Group has been *unbanned* from using BayMax Now you are happy!')
} else {
  let buttonsntnsfw = [
...
*GROUP 1*
https://chat.whatsapp.com/C5D6zr2NFQGC1UCAlgFlqY
break
case 'getsxvdxcmd': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
case 'support': case 'supportgc':
    ...
    reply(`*My developer :*https://bio.link/mrjuice`)
    break

case 'repo': case 'botrepo':
    
    reply(`*Here  follow My owner on Instagram❤️:*https://www.instagram.com/mr_juice7`)
    break
...
case 'delete': case 'del': {
 ...
 if (!isBaileys) return replay('How can i delete messages of other person bro 🙄!')
 ...
 let teks = ` 「 Marin's pm user list 」\n\nTotal ${anu.length} users are using BayMax in personal chat.`
 for (let i of anu) {
 ...
 *🎋Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
 ...
 case 'resetlinkgc':
    ...
    case 'group': case 'grup': {
     ...
     if (!vcc) return replay("Link invalid is bro!")
     if (isCreator) {
...
case 'public': {
 ...
 if (!isCreator) return reply(mess.botowner)
 Miku.public = false
 reply('Only my Owner can use me now!')
...
case 'charactercheck':
 ...
 case 'dare':
    ...
    if (isBanChat) return reply(mess.bangc)
                   const dare =[           
         "imbox ᴹᴿ᭄ ᴊᴜɪᴄᴇོ ×፝֟͜× and Tell him that you Love him😉",
         "spill people who make you pause",
         "call crush/pickle now and send ss",
         "drop only emote every time you type on gc/pc for 1 day.",
         "say Welcome to Who Wants To Be a Millionaire! to all the groups you have",
         "call ex saying Im miss u",
...
I am *BayMax*, a bot developed by *ᴹᴿ᭄ ᴊᴜɪᴄᴇོ ×፝֟͜×*.
